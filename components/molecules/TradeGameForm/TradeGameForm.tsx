...
import { Radio } from "@/components/atoms/Radio/Radio"; // Importar o componente Radio
...
import { MainImageUpload } from "@/components/molecules/MainImageUpload/MainImageUpload"; // Importar o MainImageUpload
...
type StatusType = "SELLING" | "LOOKING_FOR";
...
export const TradeGameForm = ({ gameId, initialData, onSuccess, onCancel }: TradeGameFormProps) => {
  ...
  const handleChange = (
    ...
    setFormData((prev) => ({
      ...prev,
      [name]: type === "checkbox" ? checked : name === "condition" ? (value as Condition) : value,
    }));
  };

  // Função específica para radio buttons
